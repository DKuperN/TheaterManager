...
HW-3:
- !!! изменена схема БД;
- добавлен сервис для сохранения, просмотра аспектов-счетчиков в БД
- работа сервиса проверяется в AspectServicesTest
...
(тесты дергают отдельные методы, а не работают постоянно, при постоянной работе приложения счетчики будут работать корректно(после доп настройки)).
